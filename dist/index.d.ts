...
declare const _default: {
    ...
    Cockpit: React.FC<CockpitProps>;
    version: string;
};

export { Button, Card, Cockpit, Input, _default as default, version };
export type { ButtonProps, CardProps, CockpitProps, FooterTab, FooterTabChild, FooterTabs, InputProps };
